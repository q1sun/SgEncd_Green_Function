function run_Neural_Preconditioner_Poisson1D
...
[Ah_h6, fh_h6, V_x_Gpts_h6, eigVec_A] = discrete_system_Poisson1D(number_of_elements_h6);
generate_meshPts_NN(V_x_Gpts_h6, number_of_elements_h6);

number_of_elements_h8 = 2^8;
h8 = 1 / number_of_elements_h8;
[Ah_h8, fh_h8, V_x_Gpts_h8, eigVec_A] = discrete_system_Poisson1D(number_of_elements_h8); % here, eigenfunctions of differential operator instead of eigenvectors of A is used
generate_meshPts_NN(V_x_Gpts_h8, number_of_elements_h8);

number_of_elements_h10 = 2^10;
h10 = 1 / number_of_elements_h10;
[Ah_h10, fh_h10, V_x_Gpts_h10, eigVec_A] = discrete_system_Poisson1D(number_of_elements_h10);
generate_meshPts_NN(V_x_Gpts_h10, number_of_elements_h10);

number_of_elements_h12 = 2^12;
h12 = 1/number_of_elements_h12;
[Ah_h12, fh_h12, V_x_Gpts_h12, eigVec_A] = discrete_system_Poisson1D(number_of_elements_h12);
...
%-------------------------------------------------------%
preconditioned_matrix_h6 = NN_Preconditioner_h6 * Ah_h6;
preconditioned_matrix_h8 = NN_Preconditioner_h8 * Ah_h8;
preconditioned_matrix_h10 = NN_Preconditioner_h10 * Ah_h10;
preconditioned_matrix_h12 = NN_Preconditioner_h12 * Ah_h12;
...
max_iter = 1e4;
%-------------------------------------------------------%
[x_bcg_h6,fl1,rrl_bcg_h6,iter_bcg_h6,rv1] = bicg(Ah_h6,fh_h6,tol,max_iter) ;
[x_prectd_bcg_h6,fl2,rr1_prectd_bcg_h6,iter_prectd_bcg_h6,rv2] = bicg(Ah_h6,fh_h6,rrl_bcg_h6,max_iter,@(x,flag)h6 * NN_Preconditioner_h6 * x);

function  plot_IterErr_MG_Poisson1D(eh_L2_5gMG, rh_L2_5gMG,...
    ...
    hold on
    semilogy(1:1:max_iter+1, eh_L2_5gMG,  'LineWidth',1.5 );
    hold on
    semilogy(1:1:max_iter+1, eh_L2_HbMG, 'm', 'LineWidth',1.5 );
    axis xy
    set(gca,'FontSize',18);
    set(gcf,'color','w')
    ...
    ax = gcf;
    exportgraphics(ax, sprintf('Figure/Meshsize_2e-%d/fig-Poisson1D-%s-IteErr-2Norm.pdf',index_num,mtd));
    %---------------------%
    ...
    hold on
    semilogy(1:1:max_iter+1, rh_L2_5gMG,  'LineWidth',1.5 )
    hold on
    
    semilogy(1:1:max_iter+1, rh_L2_HbMG,'m', 'LineWidth',1.5 )
    axis xy
    set(gca,'FontSize',18);
    set(gcf,'color','w')
    legend('2-grid MG',...
    ...
    set(gcf,'PaperSize',[pos(3), pos(4)]);
    ax = gcf;
    exportgraphics(ax, sprintf('Figure/Meshsize_2e-%d/fig-Poisson1D-%s-ResErr-2Norm.pdf',index_num,mtd));
    %---------------------%

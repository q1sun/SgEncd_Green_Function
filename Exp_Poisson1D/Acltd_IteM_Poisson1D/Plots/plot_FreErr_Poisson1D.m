function plot_FreErr_Poisson1D(FreErr_Hybrid,FreErr_Jacobi,index_num,mtd)
...
ax = gcf;
exportgraphics(ax, sprintf('Figure/Meshsize_2e-%d/fig-Poisson1D-%s-FreErr-Jacobi.pdf',index_num,mtd))
%---------------------%
...
set(h,'PaperPositionMode','Auto', 'PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
ax = gcf;
exportgraphics(ax, sprintf('Figure/Meshsize_2e-%d/fig-Poisson1D-%s-FreErr-Hybrid.pdf',index_num,mtd));
%---------------------%

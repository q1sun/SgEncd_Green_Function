...
ax = gcf;
exportgraphics(ax, 'Figure/Meshsize_h/fig-Poisson1D-eigenval-green-h6.pdf');
%---------------------%
...
set(groot, 'defaultAxesTickLabelInterpreter','latex'); 
ax = gcf;
exportgraphics(ax, 'Figure/Meshsize_h/fig-Poisson1D-eigenval-green-h8.pdf');
%---------------------%
...
set(groot, 'defaultAxesTickLabelInterpreter','latex'); 
ax = gcf;
exportgraphics(ax, 'Figure/Meshsize_h/fig-Poisson1D-eigenval-green-h10.pdf');
%---------------------%
...
set(groot, 'defaultAxesTickLabelInterpreter','latex'); 
ax = gcf;
exportgraphics(ax, 'Figure/Meshsize_h/fig-Poisson1D-eigenval-green-h12.pdf');
%---------------------%

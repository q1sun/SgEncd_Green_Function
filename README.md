...
| Two-Dimensional Green’s Function| Epochs | Network (Depth, Width) | Penalty Coefficients ($\beta_{\text{Snglr}}, \beta_{\text{Bndry}}, \beta_{\text{Symtr}}$) | Mini-batch Size | Learning Rate (Init., Decay) | AdamW ($\beta_1, \beta_2$) |
|----------------------|-----------|------------------|-------------------------|-------------------------------------------------------------------------------------------|------------------|-------------------------------|----------------------------|

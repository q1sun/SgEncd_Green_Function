function plot_solution_representation_Helmholtz1D( V_mesh, uh_exact, uh_NN, fh_exact )
...
ax = gcf;
exportgraphics(ax, 'Figures/Task2/fig-Helmholtz1D-Source-f.pdf')
%---------------------%
...
ax = gcf;
exportgraphics(ax, 'Figures/Task2/fig-Helmholtz1D-Solution.pdf')
%---------------------%
...
% bx.YAxis.Exponent = -3;
ax = gcf;
% saveas(ax, 'Figures/Task2/fig-Helmholtz1D-Solution-PtErr.pdf');
exportgraphics(ax, 'Figures/Task2/fig-Helmholtz1D-Solution-PtErr.pdf')
%---------------------%

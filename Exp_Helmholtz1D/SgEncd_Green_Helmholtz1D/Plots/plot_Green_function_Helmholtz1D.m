function plot_Green_function_Helmholtz1D(Green_NN, V_mesh)
...
ax = gcf;
exportgraphics(ax, 'Figures/Task1/fig-Helmholtz1D-GreenFct-NN.pdf')
%---------------------%
...
ax = gcf;
exportgraphics(ax, 'Figures/Task1/fig-Helmholtz1D-Green-NN-xyz.pdf')
%---------------------%

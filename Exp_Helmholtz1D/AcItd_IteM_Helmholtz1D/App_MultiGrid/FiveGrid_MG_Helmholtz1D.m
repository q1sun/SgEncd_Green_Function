function [eh_L2_MG, rh_L2_MG] = FiveGrid_MG_Helmholtz1D(A_list, fh, uh, R_list, maxIt, direct_n, omega)
...
% direct_n  : Threshold for directly solving A_list(level) * x = b
    ...
    x0  = zeros(coarse_n, 1);
	e_H = Multigrid_Vcycle(level + 1, A_list, R_list, rH, direct_n, x0, omega);

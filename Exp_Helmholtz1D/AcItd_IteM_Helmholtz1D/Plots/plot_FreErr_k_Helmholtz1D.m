function  plot_FreErr_k_Helmholtz1D(err_frq_Hybrid,err_frq_Jacobi,k,index_num,mtd)
    ...
    ax = gcf;
    exportgraphics(ax, sprintf('Figure/Meshsize_2e-%d/fig-Helmholtz1D-%s-FreErr-k=%d.pdf',index_num,mtd,k))
    %---------------------%
